...
@devine.on_message(filters.command("weather"))
...
__help__ = """
⟐ Weather Commands
• /weather [location or city] : Get the current weather information for a specific location or city, including temperature, humidity, wind speed, and more.
"""
